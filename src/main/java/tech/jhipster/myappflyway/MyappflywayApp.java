...
public class MyappflywayApp {

  private static final Logger log = LoggerFactory.getLogger(MyappflywayApp.class);

  private static final String SEPARATOR = "----------------------------------------------------------";
  protected static final String LF = "\n";

  public static void main(String[] args) {
    Environment env = SpringApplication.run(MyappflywayApp.class, args).getEnvironment();
